...
- [AWS](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_access-keys.html) IAM 用户 Access key 和 Secret key
#### 下载安装
...
# Bedrock Converse API 中支持的模型ID，需要模型支持 System Prompt。https://docs.aws.amazon.com/bedrock/latest/userguide/conversation-inference.html
AWS_BEDROCK_MODEL=mistral.mistral-large-2407-v1:0

AWS_REGION=us-east-1 # 使用的 AWS 区域
```
